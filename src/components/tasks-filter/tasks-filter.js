  ...
  render() {
    ...
    return (
      <ul className="filters__container">
        <li key={1}>
          <button className={classNameContainer} onClick={filterAll}>
            All
          </button>
        </li>
        <li key={2}>
          <button className={classNameContainer} onClick={filterActive}>
            Active
          </button>
        </li>
        <li key={3}>
          <button className={classNameContainer} onClick={filterCompleted}>
            Completed
          </button>
        </li>
      </ul>
